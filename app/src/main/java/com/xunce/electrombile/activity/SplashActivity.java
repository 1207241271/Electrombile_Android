...
//                            setManager.setNeedGuide(true);
    ...
    public void checkVersion() {
        FIR.checkForUpdateInFIR("f3c345fdf2b447ff0d5294772b42eed2", new VersionCheckCallback() {
            @Override
            public void onSuccess(String versionJson) {
                ...
                try {
                    String firVersionCode_str = JSONUtils.ParseJSON(versionJson, "version");
                    int firVersionCode = Integer.parseInt(firVersionCode_str);
                    String firVersionName = JSONUtils.ParseJSON(versionJson, "versionShort");
